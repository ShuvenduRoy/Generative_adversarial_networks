...
class CelebADataset(Dataset):
    def __init__(self, root='E:\\Datasets\\img_align_celeba', transform_=None, mode='train', attributes=None):
        self.tranform = transforms.Compose(transform_)

        self.selected_sttrs = attributes
    ...
    def get_annotations(self):
        """extracts annotations for CalabA"""
        annotations = {}
    ...
    def __getitem__(self, index):
        ...
        img = self.tranform(Image.open(filepath))
