...
class Data_Loader():
    ...
    def load_char(self):
        transforms = self.transform(True, True, True, True)
        dataset = dsets.ImageFolder('C:\\Users\\user\\Documents\\datasets\\BanglaLekha-Isolated\\Images', transform=transforms)
        return dataset
    ...
    def loader(self):
        ...
        elif self.dataset == 'char':
            dataset = self.load_char()
